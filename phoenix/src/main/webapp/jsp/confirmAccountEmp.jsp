...
<html>
  ...
  <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
    ...
    <header class="auxiliar">
        <div class="header-content" >
            <div class="container-fluid col-sm-6 col-sm-offset-3">
                <form class="form-horizontal formularios sing">
                	<span class="text-info">Confirmación de cuenta para su empresa: </span>
	                <span class="text-info" id="nombreEmpresa">${nombreEmpresa}</span>
     ...
     <script src="${jsControl}confirmAccountEmp.js" charset="utf-8" ></script>
  </body>
</html>
